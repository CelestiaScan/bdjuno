...
require (
	github.com/celestiaorg/celestia-app v0.4.1-0.20220516015853-60800467b1a3
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/celestiascan/cosmos-sdk v1.0.1-sdk-v0.44.2-1
	github.com/cosmos/ibc-go/v3 v3.0.0 => github.com/celestiascan/ibc-go/v3 v3.0.0-celestiascan
	github.com/forbole/juno/v3 v3.1.1 => github.com/celestiascan/juno/v3 v3.1.1-celestia
